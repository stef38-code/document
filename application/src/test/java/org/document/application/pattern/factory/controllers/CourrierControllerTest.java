...
import org.document.application.pattern.factory.services.*;
...
class CourrierControllerTest {
    private CourrierController controller;
    ...
    @BeforeEach
    void setUp() {
        CourrierService courrierNaissanceService = new CourrierNaissanceService();
        CourrierService courrierMariageService = new CourrierMariageService();
        CourrierService courrierDecesService = new CourrierDecesService();
        CourrierService courrierAutresService = new CourrierAutresService();
          controller = new CourrierController(courrierNaissanceService, courrierMariageService, courrierDecesService, courrierAutresService);
    }
