...
import org.document.application.pattern.factory.services.CreationCourrierServiceWithIf;
...
class CourrierControllerWithIfTest {
    private CourrierControllerWithIf controller;
    ...
    @BeforeEach
    void setUp() {
        CourrierServiceWithIf courrierServiceWithIf = new CreationCourrierServiceWithIf();

        controller = new CourrierControllerWithIf(courrierServiceWithIf);
    }
